...
namespace NavalArchitectureSuite.ViewModels
{
    ...
    public class ReportsViewModel : INotifyPropertyChanged
    {
        ...
        private void AddBowDesignSection(SimplePdfDocument doc)
        {
            ...
            doc.AddTwoColumn("Half Entry Angle αE",       $"{bd.HalfEntryAngleDeg:F1}°",           totalChars: 40, size: 9);
            doc.AddTwoColumn("Full Entry Angle 2αE",      $"{bd.FullEntryAngleDeg:F1}°",           totalChars: 40, size: 9);
